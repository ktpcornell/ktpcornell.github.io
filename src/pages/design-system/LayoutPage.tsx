    ...
    <>
      ...
      <section className="p-6 md:p-12 flex flex-col gap-12">
        ...
        <div>
          ...
          <p className="text-ktp-fg-body text-sm mb-4">
            Standard Tailwind breakpoints used for responsive layouts across all pages.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border border-ktp-border rounded-xl overflow-hidden">
              <thead>
                <tr className="bg-ktp-bg-surface text-ktp-primary">
              ...
              <tbody>
                {[
                  ...
                  <tr key={row.prefix} className="border-t border-ktp-border">
                    <td className="px-4 py-3 font-mono text-ktp-primary">{row.prefix}</td>
                    <td className="px-4 py-3 text-ktp-fg-body">{row.width}</td>
                    <td className="px-4 py-3 text-ktp-fg-body">{row.usage}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div>
          ...
          <div className="border border-ktp-border rounded-xl p-6 bg-white">
            <code className="text-sm font-mono bg-ktp-bg-surface px-2 py-1 rounded text-ktp-primary">
              container mx-auto px-4
            </code>
            <p className="text-sm text-ktp-fg-body mt-3 mb-0">
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <div className="border border-ktp-border rounded-xl p-6 bg-white">
              <p className="text-xs font-semibold uppercase tracking-widest text-ktp-fg-body mb-2">Standard section</p>
              <code className="text-sm font-mono bg-ktp-bg-surface px-2 py-1 rounded text-ktp-primary">
                py-16 md:py-24
              </code>
              <p className="text-sm text-ktp-fg-body mt-2 mb-0">
                Used for full-width page sections (Values, History, Gallery, etc.).
              </p>
            </div>
            <div className="border border-ktp-border rounded-xl p-6 bg-white">
              <p className="text-xs font-semibold uppercase tracking-widest text-ktp-fg-body mb-2">Content area (design system, portal)</p>
              <code className="text-sm font-mono bg-ktp-bg-surface px-2 py-1 rounded text-ktp-primary">
                p-6 md:p-12
              </code>
              <p className="text-sm text-ktp-fg-body mt-2 mb-0">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div key={item.label} className="border border-ktp-border rounded-xl p-5 bg-white">
                <p className="text-xs font-semibold uppercase tracking-widest text-ktp-fg-body mb-1">{item.label}</p>
                <code className="text-sm font-mono bg-ktp-bg-surface px-2 py-1 rounded text-ktp-primary break-all">
                  {item.code}
                </code>
                <p className="text-xs text-ktp-fg-body mt-2 mb-0">Used in: {item.usage}</p>
              </div>
            ))}
          </div>
        </div>
